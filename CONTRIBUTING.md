...
Want to show Müren some love? Help out by contributing!

## Found a bug?

Log it in our [issue tracker][ghi] or send a note to the [mailing list][ml].
Be sure to include all relevant information, like the versions of Müren and
...
The [Müren mailing list][ml] has over 900 subscribers, many of which are happy
to help out newbies or talk about potential feature additions. You can also
drop by the [#muren](irc://chat.freenode.net/#muren) channel on
...
1. **Use [Git](http://git-scm.com) and [GitHub](http://github.com):**
   ...
   [muren/muren repo](http://github.com/muren/muren/).
   Or, the [muren.github.com repo](http://github.com/muren/muren.github.com/),
...
The process for contributing to Müren's website, documentation or the book
is the same as contributing code. We use Git for versions control and GitHub to
track patch requests.

* [The muren.github.com repo](http://github.com/muren/muren.github.com/)
  is where the website sources are managed. There are almost always people in
  `#muren` that are happy to discuss, apply, and publish website patches.

* [The Book](http://muren-org-book.herokuapp.com/) has its own [Git
  repository](http://github.com/muren/muren-book/) and build process but is
  managed the same as the website and project codebase.

* [Müren Recipes](http://recipes.murenrb.com/) is a community
  project where anyone is free to contribute ideas, recipes and tutorials. Which
  also has its own [Git repository](http://github.com/muren/muren-recipes).

* [The Introduction](http://www.murenrb.com/intro.html) is generated from
  Müren's [README file](http://github.com/muren/muren/blob/main/README.md).

* If you want to help translating the documentation, the README is already
  available in
  [Japanese](http://github.com/muren/muren/blob/main/README.ja.md),
  [German](http://github.com/muren/muren/blob/main/README.de.md),
  [Chinese](https://github.com/muren/muren/blob/main/README.zh.md),
  [Russian](https://github.com/muren/muren/blob/main/README.ru.md),
  [European](https://github.com/muren/muren/blob/main/README.pt-pt.md) and
  [Brazilian](https://github.com/muren/muren/blob/main/README.pt-br.md)
  Portuguese,
  [French](https://github.com/muren/muren/blob/main/README.fr.md),
  [Spanish](https://github.com/muren/muren/blob/main/README.es.md),
  [Korean](https://github.com/muren/muren/blob/main/README.ko.md), and
  [Hungarian](https://github.com/muren/muren/blob/main/README.hu.md).
...
[ghi]: http://github.com/muren/muren/issues
[ml]: http://groups.google.com/group/murenrb/topics "Müren Mailing List"

* ["Help Wanted"](https://github.com/muren/muren/labels/help%20wanted):  Anyone willing to pitch in is open to contribute to this ticket as they see fit (will try to add context / summarize or ask for requirements)

* ["Good First Issue"](https://github.com/muren/muren/labels/good%20first%20issue): Potential first time contributors should start here

* ["Wishlist"](https://github.com/muren/muren/labels/Wishlist): All the things I wish we had but have no time for
