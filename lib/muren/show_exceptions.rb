...
module Muren
  # Muren::ShowExceptions catches all exceptions raised from the app it
  ...
  class ShowExceptions < Rack::ShowExceptions
    ...
    def frame_class(frame)
      if frame.filename =~ %r{lib/muren.*\.rb}
        'framework'
...
<body>
  <div id="wrap">
    <div id="header">
      <img src="<%= env['SCRIPT_NAME'] %>/__muren__/500.png" alt="application error" height="161" width="313" />
      <div id="summary">
