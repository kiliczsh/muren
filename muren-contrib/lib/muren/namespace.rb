...
module Muren
  # = Muren::Namespace
  #
  # <tt>Muren::Namespace</tt> is an extension that adds namespaces to an
  ...
  # module.
  #
  #     require 'muren/base' # For creating Muren extensions
  #     require 'muren/namespace' # To create namespaces
  #
  ...
  #       Muren.register Routes
  #     end
  #
  # In order to use this extension, is the same as any other Muren extension:
  #
  #     module Zomg
  ...
  #
  # I hope that helps you use `Muren::Namespace` in every way imaginable!
  #
  module Namespace
    ...
    module SharedMethods
      def namespace(pattern, conditions = {}, &block)
        Muren::Namespace.new(self, pattern, conditions, &block)
      end
    end
    ...
    module NamespacedMethods
      ...
      def error(*codes, &block)
        args  = Muren::Base.send(:compile!, 'ERROR', /.*/, block)
