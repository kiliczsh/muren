...
module Muren
  ...
  #
  # Helps you spinning up and shutting down your own muren app. This is especially helpful for running
  # real network tests against a muren backend.
  #
