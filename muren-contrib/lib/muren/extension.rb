...
module Muren
  # = Muren::Extension
  #
  # <tt>Muren::Extension</tt> is a mixin that provides some syntactic sugar
  # for your extensions. It allows you to call almost any
  # <tt>Muren::Base</tt> method directly inside your extension
  ...
  # Muren application that has been extended.  In order to do that, it
  ...
  #
  #     require 'muren/extension'
  #
  #     module MyExtension
  #       extend Muren::Extension
  #
  ...
  #
  #     MyExtension = Muren::Extension.new do
  #       # Your extension code goes here...
  #     end
  #
  # This is useful when you just want to pass a block to
  # <tt>Muren::Base.register</tt>.
  module Extension
    def self.new(&block)
    ...
    def method_missing(method, *args, &block)
      return super unless Muren::Base.respond_to? method
