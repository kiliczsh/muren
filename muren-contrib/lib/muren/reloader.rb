...
module Muren
  ...
  #
  #     require "muren"
  #     require "muren/reloader" if development?
  #
  ...
  #
  #     require "muren/base"
  #     require "muren/reloader"
  #
  #     class MyApp < Muren::Base
  #       configure :development do
  #         register Muren::Reloader
  #       end
  #
  ...
  module Reloader
    ...
    class Watcher
      # Represents an element of a Muren application that may need to
    ...
    # When the extension is registered it extends the Muren application
    ...
    def self.registered(klass)
      ...
      klass.set(:inline_templates, klass.app_file) if klass == Muren::Application
    end
    ...
    # Contains the methods defined in Muren::Base that are overridden.
    module BaseMethods
      # Protects Muren::Base.run! from being called more than once.
      def run!(*args)
      ...
      # Does everything Muren::Base#route does, but it also tells the
      # +Watcher::List+ for the Muren application to watch the defined
      # route.
      #
      ...
      # Does everything Muren::Base#inline_templates= does, but it also
      # tells the +Watcher::List+ for the Muren application to watch the
      ...
      # Does everything Muren::Base#use does, but it also tells the
      # +Watcher::List+ for the Muren application to watch the middleware
      # being used.
      ...
      # Does everything Muren::Base#add_filter does, but it also tells
      # the +Watcher::List+ for the Muren application to watch the defined
      # filter.
      ...
      # Does everything Muren::Base#error does, but it also tells the
      # +Watcher::List+ for the Muren application to watch the defined
      # error handler.
      ...
      # Does everything Muren::Base#register does, but it also lets the
      ...
      # Does everything Muren::Base#register does and then registers the
      # reloader in the +subclass+.
      def inherited(subclass)
        result = super
        subclass.register Muren::Reloader
        result
      end
    end

    # Contains the methods that the extension adds to the Muren application.
    module ExtensionMethods
      # Removes the +element+ from the Muren application.
